...
const GOAL_MAP: Record<string, GoalMap> = {
  ...
  handle_objection:          { category: "objection_handling", skill_type: "objection_response", slug_hint: "objection_response_router" },
  handle_objection_price:    { category: "objection_handling", skill_type: "objection_response", slug_hint: "objection_response_router" },
  handle_objection_vendor:   { category: "objection_handling", skill_type: "objection_response", slug_hint: "objection_response_router" },
  handle_objection_think:    { category: "objection_handling", skill_type: "objection_response", slug_hint: "objection_response_router" },
  handle_objection_no_time:  { category: "objection_handling", skill_type: "objection_response", slug_hint: "objection_response_router" },
  handle_objection_send_proposal: { category: "objection_handling", skill_type: "objection_response", slug_hint: "objection_response_router" },
  handle_objection_not_now:  { category: "objection_handling", skill_type: "objection_response", slug_hint: "objection_response_router" },
