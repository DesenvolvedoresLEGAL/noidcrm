...
const REPORT_KEY = "stage_conversion_v2";
const VIEW = "v_report_stage_conversion_v2";
const COLS = new Set(["organization_id", "pipeline_id"]);
...
serve(async (req) => {
  ...
  else q = q.order("transition_count", { ascending: false });
