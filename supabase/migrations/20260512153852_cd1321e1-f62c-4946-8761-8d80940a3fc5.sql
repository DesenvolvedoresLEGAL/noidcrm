...
BEGIN
  ...
  -- =========================================================================
  -- NET CALCULATION (PRICE UX 1.0.5):
  -- effective_one_time = dynamic current_amount (if active) ELSE one_time_total
  -- net_one_time = effective_one_time * (1 - discount_percent/100)
  -- net_total = net_one_time + recurring_total
  -- This NET is the source of truth for "Valor Vigente" in opportunity cards,
  -- forecast, dashboard and reports. Public proposal breakdown uses
  -- dynamic_pricing_current_amount as gross subtotal vigente.
  -- =========================================================================
