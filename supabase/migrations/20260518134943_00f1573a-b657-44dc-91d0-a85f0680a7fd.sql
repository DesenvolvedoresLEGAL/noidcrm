...
BEGIN
  ...
  IF v_is_event THEN
    -- Pega o termo "ativo" (mais recente). Se ele não tiver custom_schedule mas existir
    -- outro termo com custom_schedule, prefere o de custom_schedule.
    ...
    -- Detectar maior data de vencimento entre TODOS os termos one_time
    -- (cobre cronogramas manuais em linhas duplicadas)
    FOR v_term IN
