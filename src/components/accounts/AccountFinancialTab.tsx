      ...
      <Card>
        <CardContent className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <p className="text-sm text-muted-foreground max-w-md">
            Os dados financeiros desta conta ainda não foram sincronizados pelo ERP.
            Quando o webhook enviar as informações, elas aparecerão aqui automaticamente.
          </p>
        </CardContent>
      </Card>
    );
          ...
          <div className="flex items-center justify-between">
            ...
            {account.score_calculado_em && (
              <div className="flex items-center gap-1 text-xs text-muted-foreground">
                ...
                Atualizado em {formatDateBR(account.score_calculado_em)}
              </div>
            )}
          </div>
        </CardHeader>
