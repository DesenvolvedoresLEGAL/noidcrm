  ...
  if (isEditing) {
    ...
    return (
      <div className={cn('relative', className)}>
        {label && <span className="text-[11px] text-muted-foreground block leading-tight">{label}</span>}
  ...
  return (
    <div className={cn('group relative', className)}>
      ...
      >
        ...
        <span className="flex-1 text-xs font-medium leading-snug">{displayValue || placeholder}</span>
