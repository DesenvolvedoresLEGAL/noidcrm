  ...
  public: {
    Tables: {
      ...
      ai_agent_escalation_policies: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_agent_escalation_policies_agent_id_fkey"
            columns: ["agent_id"]
            isOneToOne: false
            referencedRelation: "ai_agents"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ai_agent_escalation_policies_agent_version_id_fkey"
            columns: ["agent_version_id"]
            isOneToOne: false
            referencedRelation: "ai_agent_versions"
            referencedColumns: ["id"]
      ...
      ai_agent_memory_profiles: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_agent_memory_profiles_agent_id_fkey"
            columns: ["agent_id"]
            isOneToOne: false
            referencedRelation: "ai_agents"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ai_agent_memory_profiles_agent_version_id_fkey"
            columns: ["agent_version_id"]
            isOneToOne: false
            referencedRelation: "ai_agent_versions"
            referencedColumns: ["id"]
      ...
      ai_agent_prompt_layers: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_agent_prompt_layers_agent_id_fkey"
            columns: ["agent_id"]
            isOneToOne: false
            referencedRelation: "ai_agents"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ai_agent_prompt_layers_agent_version_id_fkey"
            columns: ["agent_version_id"]
            isOneToOne: false
            referencedRelation: "ai_agent_versions"
            referencedColumns: ["id"]
      ...
      ai_agent_rulesets: {
        Row: {
          agent_id: string
          agent_version_id: string
          business_constraints_json: Json
          created_at: string
          id: string
          organization_id: string
          risk_controls_json: Json
          rules_json: Json
          updated_at: string
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_agent_rulesets_agent_id_fkey"
            columns: ["agent_id"]
            isOneToOne: false
            referencedRelation: "ai_agents"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ai_agent_rulesets_agent_version_id_fkey"
            columns: ["agent_version_id"]
            isOneToOne: false
            referencedRelation: "ai_agent_versions"
            referencedColumns: ["id"]
      ...
      ai_agent_tools: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "ai_agent_tools_agent_version_id_fkey"
            columns: ["agent_version_id"]
            isOneToOne: false
            referencedRelation: "ai_agent_versions"
            referencedColumns: ["id"]
          ...
          },
          {
            ...
            columns: ["tool_id"]
            isOneToOne: false
            referencedRelation: "ai_tools_registry"
            referencedColumns: ["id"]
          },
        ]
      }
      ai_agent_triggers: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "ai_agent_triggers_agent_version_id_fkey"
            columns: ["agent_version_id"]
            isOneToOne: false
            referencedRelation: "ai_agent_versions"
            referencedColumns: ["id"]
      ...
      ai_usage_logs: {
        Row: {
          ...
          user_id: string | null
          volts_rate: number | null
          volts_used: number | null
        }
        Insert: {
          action: string
          created_at?: string
      ...
      conversation_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "conversation_logs_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: false
            referencedRelation: "accounts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "conversation_logs_contact_id_fkey"
            columns: ["contact_id"]
            isOneToOne: false
            referencedRelation: "contacts"
            referencedColumns: ["id"]
      ...
      revenue_events: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "revenue_events_contact_id_fkey"
            columns: ["contact_id"]
            isOneToOne: false
            referencedRelation: "contacts"
            referencedColumns: ["id"]
      ...
      win_loss_records: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "win_loss_records_reason_id_fkey"
            columns: ["reason_id"]
            isOneToOne: false
            referencedRelation: "loss_reasons"
            referencedColumns: ["id"]
      ...
      winloss_interviews: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            isOneToOne: false
            referencedRelation: "v_win_loss_records_normalized_v2"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "winloss_interviews_win_loss_record_id_fkey"
    ...
    Views: {
      ...
      v_ai_reports_context_v2: {
        Row: {
          ...
          organization_id: string | null
          origem: string | null
          overdue_close_date_flag: boolean | null
          owner_user_id: string | null
          pipeline_id: string | null
          qualified_by_user_id: string | null
      ...
      v_ai_reports_summary_context_v2: {
        Row: {
          active_pipeline_value: number | null
          confidence_score: number | null
          forecast_closed_revenue: number | null
          forecast_weighted_value: number | null
          lost_value: number | null
          organization_id: string | null
          reconcile_last_at: string | null
      ...
      v_loss_classification_coverage_v2: {
        Row: {
          ...
          client_only_count: number | null
          complete_coverage_pct: number | null
          fully_classified_count: number | null
          organization_id: string | null
          seller_only_count: number | null
          total_lost_opportunities: number | null
          unclassified_legacy_count: number | null
          win_loss_only_count: number | null
        }
        Relationships: [
          {
            foreignKeyName: "opportunities_organization_id_fkey"
      ...
      v_loss_reason_rollup_v2: {
        Row: {
          ...
          lost_count: number | null
          organization_id: string | null
          with_client_reason_count: number | null
        }
        Relationships: [
          {
            foreignKeyName: "opportunities_organization_id_fkey"
      ...
      v_opportunity_amount_coverage_v2: {
        Row: {
          ...
          total_opportunities: number | null
          using_accepted_proposal_net: number | null
          using_latest_proposal_net: number | null
          using_opportunity_fallback: number | null
          using_zero_fallback: number | null
        }
        Relationships: [
          {
            foreignKeyName: "opportunities_organization_id_fkey"
      ...
      v_opportunity_current_owner_v2: {
        Row: {
      ...
      v_opportunity_current_stage_entry_v2: {
        Row: {
          changed_by_user_id: string | null
          current_stage_id: string | null
      ...
      v_opportunity_first_owner_v2: {
        Row: {
          first_owner_at: string | null
      ...
      v_opportunity_first_qualification_v2: {
        Row: {
          first_qualification_at: string | null
      ...
      v_opportunity_history_coverage_v2: {
        Row: {
          ...
          qualification_history_coverage_pct: number | null
          stage_history_coverage_pct: number | null
          total_opportunities: number | null
          with_owner_history: number | null
          with_qualification_history: number | null
          with_stage_history: number | null
        }
        Relationships: [
          {
            foreignKeyName: "opportunities_organization_id_fkey"
      ...
      v_opportunity_latest_commercial_proposal_v2: {
        Row: {
          accepted_at: string | null
          created_at: string | null
          discount_amount: number | null
      ...
      v_report_legacy_retirement_readiness_v2: {
        Row: {
          confidence_score: number | null
          ...
          reasons: Json | null
          reconcile_consistent: boolean | null
          reconcile_severity: string | null
          report_key: string | null
        }
        Relationships: []
      }
      v_report_losses_detail_v2: {
        Row: {
          amount_source: string | null
          client_loss_reason_category: string | null
          client_loss_reason_id: string | null
      ...
      v_report_summary_v2: {
        Row: {
          active_pipeline_count: number | null
          active_pipeline_value: number | null
          avg_won_ticket: number | null
          lost_count: number | null
          lost_value: number | null
